...
-   added illustrations for reasoned decision-making:
    ...
    -   `agreements/reasoned-decision-making-table`
    -   `agreements/reasoned-decision-making`
- updated `agreements/consent-decision-making` to align with the updated description of the process
- updated the following illustrations to align with the style of the recent process illustrations
...
-   revised text of the following CSF illustrations:
    -   `csf/03 Orientation Slide`
    -   `csf/06 Transformation Slide`
    -   `csf/07 All principles`
    -   `csf/07a All principles (large)`
...
-   renamed ""
-   `process/driver-mapping` revised text
...
- updated pattern names in 
    ...
    -   `pattern-groups/group-1` and `pattern-groups/group-3`
- revised text: 
...
-   updated `pattern-groups/group-3` and `framework/pattern-map` to include new pattern names
